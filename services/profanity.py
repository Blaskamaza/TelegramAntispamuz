...
def check_for_profanity_all(text: str) -> tuple[bool, str | None]:
    ...
    # Additional blacklist for NSFW/prohibited content
    nsfw_blacklist = [
        # English
        "porn", "porno", "xxx", "onlyfans", "pornhub", "xvideos",
        # Russian
        "порно", "порнуха", "порнушка",
        # International
        "seks", "секс", "adult", "18+",
    ]
    
    # Uzbek profanity and insults (Latin + Cyrillic)
    uzbek_profanity = [
        # === ОСНОВНОЙ МАТ (латиница) ===
        "sik", "sikish", "sikin", "sikaman", "sikay", "sikdim", "sikib", "siktirgich",
        "qo'tak", "qotak", "kotak", "ko'tak", "kutok",
        "am", "amini", "amingni", "amingga",
        "jala", "jalap", "jalab",
        "qanchik", "qanjiq", "kanchik",  # сука
        
        # === ПРОСТИТУТКА / ШЛЮХА ===
        "fohisha", "fohiша", "fahisha", "buzuq", "buzuqi",
        "loli", "qaltaq", "qashqir",
        
        # === ОСКОРБЛЕНИЯ (латиница) ===
        "axmoq", "ahmoq", "tentak", "jinni", "ovsar", "hayvon", "maymun",
        "it", "itning", "itdan", "itvachchasi", "kuchuk", "kuchukcha",
        "eshak", "eshakning", "eshakday", "eshakbosh",
        "cho'chqa", "chochqa", "to'nka", "tonka", "donkey",
        "badnafs", "badzot", "badzod", "harom", "haromzoda", "haromdan",
        "iflos", "siyqali", "yaramas", "yaramagan", "yaramay",
        "murdor", "sassiq", "sasiq", "badbo'y",
        "kasofat", "kasofat", "ablah", "nodon",
        "tuban", "past", "pastkash", "razil", "yirtqich",
        "benomus", "sharmsiz", "uyatsiz", "sharmanda",
        "yolg'onchi", "yolgonchi", "aldamchi", "firibgar",
        "qo'l tekkiz", "og'zingni yop",
        "onangni", "onang", "onasini",  # оскорбления с "мать"
        "otangni", "otang", "otasini",  # оскорбления с "отец"
        "xotin", "xotiningni",  # в контексте оскорбления
        "kampir", "kampirday",
        
        # === ВАРИАЦИИ НА КИРИЛЛИЦЕ ===
        "сик", "сикиш", "сикиб", "сикдим", "сиктиргич",
        "қўтак", "котак", "кутак", "куток",
        "ам", "амини", "амингни",
        "жала", "жалаб", "жалап",
        "қанжиқ", "қанчиқ", "канчик", "канжик",  # сука
        "фохиша", "фахиша", "бузуқ",  # проститутка
        "ахмоқ", "тентак", "жинни", "ҳайвон", "овсар", "маймун",
        "ит", "итнинг", "итваччаси", "кучук",
        "эшак", "эшакнинг", "эшакбош",
        "чўчқа", "тўнка", "харом", "харомзода",
        "ифлос", "ярамас", "яраамс",
        "мурдор", "сассиқ", "бадбўй",
        "касофат", "аблаҳ", "нодон",
        "тубан", "паст", "пасткаш", "разил",
        "беномус", "шармсиз", "уятсиз", "шарманда",
        "онангни", "онанг", "онасини",
        "отангни", "отанг", "отасини",
        
        # === ГРУБЫЕ ВЫРАЖЕНИЯ ===
        "bo'yniga ol", "bo'yningga", "jin ursin", "jinni ur",
        "o'lib ket", "o'lgur", "o'lay", "o'lasan",  # пожелания смерти
        "la'nat", "lanat", "la'nati",
        "shaytan", "shayton", "iblisday", "iblis",
        "jo'ra", "kal", "ko'r", "kar",  # оскорбления по внешности
        "semiz", "yog'", "oriq",
        
        # === РУССКИЙ МАТ В УЗБЕКСКОМ КОНТЕКСТЕ ===
        "сука", "блядь", "бляд", "шлюха", "шалава", "курва",
        "пизда", "пиздец", "хуй", "хуйня", "ёбаный", "ёб",
        "мудак", "мудила", "дебил", "даун", "уёбок", "уёбище",
        "пидор", "пидорас", "гомик", "педик",
        "чмо", "чмошник", "лох", "лошара",
        
        # === СЛОВА С ДВОЙНЫМ СМЫСЛОМ ===
        "siqish", "toqish", "tiqish", "so'kish",
    ]
    
    text_lower = text.lower()
    
    # Check NSFW blacklist
    for word in nsfw_blacklist:
        if word in text_lower:
            return True, word
    
    # Check Uzbek profanity
    for word in uzbek_profanity:
        if word in text_lower:
            return True, word
